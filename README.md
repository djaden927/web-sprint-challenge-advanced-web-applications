...
A token is a way to prove authentication. A server returns a token upon successfully providing username/password, and you can then show that token to get back into the system, rather than providing full credentials over and over. It's kind of like getting your hand stamped at a theme park so you don't have to pay every time you leave and re-enter the park. 
